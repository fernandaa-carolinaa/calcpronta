                ...
                list.innerHTML += `
                    <li class="list-group-item m-2 p-2 border-bottom">
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col">
                                <button class="btn btn-dark btn-sm float-end ms-2" onclick="showEditForm(${tipo.id}, '${tipo.nome}')">Editar</button>
                                <button class="btn btn-secondary btn-sm float-end" onclick="deleteTipoDispositivo(${tipo.id})">Deletar</button>
                            </div>
                        </div>
                    </li>`;
            });
