...
function fetchBandeiras() {
    fetch('http://localhost:8000/bandeiras')
        ...
        .then(data => {
            ...
            list.innerHTML = '<ul class="list-group border border">';
                ...
                list.innerHTML += `
                    <li class="list-group-item m-2 p-2 border-bottom">
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col">
                                <button class="btn btn-secondary btn-sm float-end ms-2" onclick="showEditForm(${bandeira.id}, '${bandeira.nome}', ${bandeira.tarifa})">Editar</button>
                                <button class="btn btn-dark btn-sm float-end" onclick="deleteBandeira(${bandeira.id})">Deletar</button>
                            </div>
                        </div>
                    </li>`;
            });
